...
UFooComponent::UFooComponent()
{

  PrimaryComponentTick.bCanEverTick = false;

  OnComponentBeginOverlap.AddDynamic(this,
    &UFooComponent::BeginOverlapCallBack);
  OnComponentEndOverlap.AddDynamic(this,
    &UFooComponent::EndOverlapCallBack);
...
void UFooComponent::Attach(USceneComponent* _parent) {
...
ADefaultUnit* UFooComponent::GetAttackTarget() {
...
void UFooComponent::SetTeamFlag(const TeamFlag& _team_flag) {
  team_flag_ = _team_flag;
}

void UFooComponent::Work() {
...
void UFooComponent::BeginOverlapCallBack(
...
void UFooComponent::EndOverlapCallBack(
  UPrimitiveComponent* _overlap_component,
  AActor* _other_actor,
  UPrimitiveComponent* _other_component,
  int32 _other_body_idx) {
...
void UFooComponent::SetAttackRange(const float& _attack_range) {
...
bool UFooComponent::HasAlreadyAdded(ADefaultUnit* _actor) {
