...
#include "RangeUnitAttackRangeComponent.generated.h"
 ...
 */
UCLASS()
class TOY_API URangeUnitAttackRangeComponent : public UBoxComponent,
                                               public IAttackRangeInterface
{
 ...
 private:
   ...
   OverlapObjectContainer<ASquad> overlap_object_container_;
